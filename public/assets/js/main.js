...
function displayProducts(products, itemBoxId) {
  ...
  const filteredProducts = products.filter((product) => product.category === '커피');
...
function displayProductsByTaste(products, taste, itemBoxId) {
  ...
  if (taste === 'all') {
    filteredProducts = products.filter((product) => product.category === '커피');
  } else {
    filteredProducts = products.filter((product) => product.category === '커피' && product.taste === taste);
  }
...
document.addEventListener('DOMContentLoaded', async () => {
  try {
    ...
    displayProducts(products, 'pickItemBox'); // 모든 커피 상품 표시
    ...
    tabLabels.forEach((label) => {
      ...
      label.addEventListener('click', (event) => {
        displayProductsByTaste(products, taste, 'pickItemBox');
